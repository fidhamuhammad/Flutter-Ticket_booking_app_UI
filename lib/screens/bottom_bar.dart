...
class _BottomBarState extends State<BottomBar> {
  int _selectedIndex = 0; //declare a variable
  ...
  // create a method as _onItemTapped with index as parameter
  void _onItemTapped(int index) {
    setState(() {
      //set state helps you to rebuild the ui
      _selectedIndex =
          index; //when calling the function _onItemTapped the _selectedIndex should reflected
    });
  }
